...
```sh
$ git clone https://github.com/huaweicloud/terraform-provider-huaweicloudstack.git $GOPATH/src/github.com/terraform-providers/terraform-provider-huaweicloudstack
```
...
$ git clone https://github.com/huaweicloud/terraform-provider-huaweicloudstack.git ~/go/src/github.com/terraform-providers/terraform-provider-huaweicloudstack
