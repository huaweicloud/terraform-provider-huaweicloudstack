		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"huaweicloudstack_compute_instance_v2.instance_1", "availability_zone", OS_AVAILABILITY_ZONE),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckComputeV2InstanceExists(
						"huaweicloudstack_compute_instance_v2.instance_1", &instance_1),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeV2InstanceExists(
						"huaweicloudstack_compute_instance_v2.instance_1", &instance1_1),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeV2InstanceExists(
						"huaweicloudstack_compute_instance_v2.instance_1", &instance1_2),
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"huaweicloudstack_compute_instance_v2.instance_1", "all_metadata.foo", "bar"),
					resource.TestCheckResourceAttr(
						"huaweicloudstack_compute_instance_v2.instance_1", "all_metadata.abc", "def"),
				),
			},
			{
...
func testAccCheckComputeV2InstanceDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "huaweicloudstack_compute_instance_v2" {
			continue
		}
...
resource "huaweicloudstack_networking_secgroup_v2" "secgroup_1" {
  name = "huaweicloudstack_acctest_secgroup_1"
  description = "a security group"
}

resource "huaweicloudstack_compute_instance_v2" "instance_1" {
  name = "instance_1"
  security_groups = ["default", "${huaweicloudstack_networking_secgroup_v2.secgroup_1.name}"]
  network {
    uuid = "%s"
  }
}
...
resource "huaweicloudstack_networking_secgroup_v2" "secgroup_2" {
  name = "huaweicloudstack_acctest_secgroup_2"
...
resource "huaweicloudstack_compute_instance_v2" "instance_1" {
  name = "instance_1"
  security_groups = ["default", "${huaweicloudstack_networking_secgroup_v2.secgroup_1.name}", "${huaweicloudstack_networking_secgroup_v2.secgroup_2.name}"]
  network {
    uuid = "%s"
  }
}
...
resource "huaweicloudstack_blockstorage_volume_v2" "vol_1" {
  name = "vol_1"
  size = 50
  image_id = "%s"
}
...
resource "huaweicloudstack_compute_instance_v2" "instance_1" {
  ...
  block_device {
    uuid = "${huaweicloudstack_blockstorage_volume_v2.vol_1.id}"
    source_type = "volume"
    boot_index = 0
    destination_type = "volume"
    delete_on_termination = true
...
resource "huaweicloudstack_compute_instance_v2" "instance_1" {
  depends_on = ["huaweicloudstack_networking_subnet_v2.subnet_1"]
  ...
  network {
    uuid = "${huaweicloudstack_networking_network_v2.network_1.id}"
...
resource "huaweicloudstack_compute_instance_v2" "instance_1" {
  ...
  network {
    name = "${huaweicloudstack_networking_network_v2.network_1.name}"
  }
...
resource "huaweicloudstack_networking_port_v2" "port_3" {
  name = "port_3"
  network_id = "${huaweicloudstack_networking_network_v2.network_1.id}"
  admin_state_up = "true"
...
resource "huaweicloudstack_networking_port_v2" "port_4" {
  name = "port_4"
  network_id = "${huaweicloudstack_networking_network_v2.network_2.id}"
  admin_state_up = "true"
...
resource "huaweicloudstack_compute_instance_v2" "instance_1" {
  depends_on = [
    "huaweicloudstack_networking_subnet_v2.subnet_1",
    "huaweicloudstack_networking_subnet_v2.subnet_2",
    "huaweicloudstack_networking_port_v2.port_1",
    "huaweicloudstack_networking_port_v2.port_2",
  ]
  ...
  network {
    uuid = "${huaweicloudstack_networking_network_v2.network_2.id}"
  ...
  network {
    port = "${huaweicloudstack_networking_port_v2.port_3.id}"
  }

  network {
    port = "${huaweicloudstack_networking_port_v2.port_4.id}"
  }
}
`, OS_NETWORK_ID)
