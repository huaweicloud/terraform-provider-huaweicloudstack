		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckKmsKeyV1DataSourceID("data.huaweicloudstack_kms_key_v1.key1"),
					resource.TestCheckResourceAttr(
						"data.huaweicloudstack_kms_key_v1.key1", "key_alias", keyAlias),
				),
			},
		},
	})
...
%s
data "huaweicloudstack_kms_key_v1" "key1" {
  key_alias       = "${huaweicloudstack_kms_key_v1.key1.key_alias}"
