...
sidebar_current: "docs-huaweicloudstack-resource-networking-port-v2"
description: |-
  Manages a V2 port resource within HuaweiCloudStack.
---

# huaweicloudstack\_networking\_port_v2
...
```
$ terraform import huaweicloudstack_networking_port_v2.port_1 eae26a3e-1c33-4cc1-9c31-0cd729c438a1
```
...
Ports. Please see the `huaweicloudstack_compute_instance_v2` documentation for further
documentation.
