...
page_title: "HuaweiCloudStack: huaweicloudstack_compute_instance_v2"
sidebar_current: "docs-huaweicloudstack-resource-compute-instance-v2"
description: |-
  Manages a V2 VM instance resource within HuaweiCloudStack.
---

# huaweicloudstack\_compute\_instance_v2
...
```hcl
resource "huaweicloudstack_compute_instance_v2" "basic" {
  name              = "basic"
...
```hcl
resource "huaweicloudstack_blockstorage_volume_v2" "myvol" {
  name = "myvol"
  size = 1
}

resource "huaweicloudstack_compute_instance_v2" "myinstance" {
  name              = "myinstance"
  image_id          = "ad091b52-742f-469e-8f3c-fd81cadf0743"
  flavor_id         = "3"
  key_pair          = "my_key_pair_name"
...
resource "huaweicloudstack_compute_volume_attach_v2" "attached" {
  ...
  volume_id  = "${huaweicloudstack_blockstorage_volume_v2.myvol.id}"
}
```
...
```hcl
resource "huaweicloudstack_compute_instance_v2" "boot-from-volume" {
...
```hcl
resource "huaweicloudstack_blockstorage_volume_v1" "myvol" {
  name     = "myvol"
  size     = 5
  image_id = "<image-id>"
}
...
resource "huaweicloudstack_compute_instance_v2" "boot-from-volume" {
  ...
  block_device {
    uuid                  = "${huaweicloudstack_blockstorage_volume_v1.myvol.id}"
    source_type           = "volume"
    boot_index            = 0
    destination_type      = "volume"
    delete_on_termination = true
...
```hcl
resource "huaweicloudstack_networking_floatingip_v2" "myip" {
  pool = "admin_external_net"
}

resource "huaweicloudstack_compute_instance_v2" "multi-net" {
  name              = "multi-net"
  image_id          = "ad091b52-742f-469e-8f3c-fd81cadf0743"
  flavor_id         = "3"
  key_pair          = "my_key_pair_name"
...
resource "huaweicloudstack_compute_floatingip_associate_v2" "myip" {
...
```hcl
resource "huaweicloudstack_compute_instance_v2" "multi-eph" {
  name              = "multi_eph"
  image_id          = "ad091b52-742f-469e-8f3c-fd81cadf0743"
  flavor_id         = "3"
  key_pair          = "my_key_pair_name"
...
Instances can be imported by the `id`. For example,

```
terraform import huaweicloudstack_compute_instance_v2.my_instance b11b407c-e604-4e8d-8bc4-92398320b847
```
...
```
resource "huaweicloudstack_compute_instance_v2" "foo" {
  name            = "terraform-test"
  security_groups = ["default"]
...
resource "huaweicloudstack_compute_instance_v2" "instance_1" {
  ...
  connection {
    user        = "root"
    host        = "${huaweicloudstack_networking_port_v2.port_1.fixed_ip.0.ip_address}"
