...
page_title: "HuaweiCloudStack: huaweicloudstack_lb_certificate_v2"
sidebar_current: "docs-huaweicloudstack-resource-lb-certificate-v2"
description: |-
  Manages a V2 certificate resource within HuaweiCloudStack.
---

# huaweicloudstack\_lb\_certificate\_v2
...
```hcl
resource "huaweicloudstack_lb_certificate_v2" "certificate_1" {
  name = "certificate_1"
...
* `region` - (Optional) The region in which to obtain the V2 Networking client.
    ...
    Changing this creates a new LB certificate.

* `name` - (Optional) Human-readable name for the Certificate.
